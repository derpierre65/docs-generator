...
// #[Property('acting_as', [PropertyType::OBJECT, PropertyType::NULL], new Schema('User', exclude: ['acting_as']))]
#[Property('acting_as', PropertyType::OBJECT, new Schema('User', exclude: ['acting_as']))]
